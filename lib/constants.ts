...
export const CATEGORIES = [
  ...
  },
  {
    slug: 'chess-bullet',
    name: 'Bullet',
    external_url: 'https://chess.com/play/online/bullet',
    score_type: 'higher_better' as const,
    unit: '',
    description: 'Chess.com bullet rating',
    isChess: true,
  },
  {
    slug: 'chess-blitz',
    name: 'Blitz',
    external_url: 'https://chess.com/play/online/blitz',
    score_type: 'higher_better' as const,
    unit: '',
    description: 'Chess.com blitz rating',
    isChess: true,
  },
  {
    slug: 'chess-rapid',
    name: 'Rapid',
    external_url: 'https://chess.com/play/online/rapid',
    score_type: 'higher_better' as const,
    unit: '',
  ...
  },
  {
    slug: 'chess-daily',
    name: 'Daily',
    external_url: 'https://chess.com/play/online/daily',
    score_type: 'higher_better' as const,
    unit: '',
    description: 'Chess.com daily rating',
    isChess: true,
  },
  {
    slug: 'puzzle-rush',
    name: 'Puzzle Rush',
    external_url: 'https://chess.com/puzzles/rush',
    score_type: 'higher_better' as const,
    unit: '',
